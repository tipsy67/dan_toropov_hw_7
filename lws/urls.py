...
urlpatterns = [
    ...
    path('lesson/<int:pk>/update', views.LessonUpdateAPIView.as_view(), name='user_update'),
    path('lesson/<int:pk>/delete', views.LessonDestroyAPIView.as_view(), name='user_delete'),
